...
// export const start = (done: (err?: any, server?: express.Express, storage?: any) => void, useJsonStorage?: boolean): void => {
//     let storage: Storage;
//     let isKeyVaultConfigured: boolean;
//     let keyvaultClient: any;
...
//             app.use(fileUploadMiddleware, api.management({ storage: storage }));
